  ...
  execFileSync(
    ...
    [
      ...
      [
        ...
        "Add-Type -TypeDefinition 'using System; using System.Runtime.InteropServices; public static class NativeWindow { [DllImport(\"user32.dll\")] public static extern IntPtr GetForegroundWindow(); }'",
        ...
        '} while ($null -eq $confirmButton -and (Get-Date) -lt $deadline)',
        "if ($null -eq $confirmButton) { throw ('Could not find the native folder confirmation button. Buttons found: ' + ($buttonNames -join ', ')) }",
