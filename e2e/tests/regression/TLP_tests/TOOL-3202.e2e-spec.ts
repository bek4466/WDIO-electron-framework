...
const systemInfoFileTemp = path.join(__dirname, "..", "..", "..", "resources", "HWTLPProject", "systeminfoTmp.json");
const systemInfoFilePath = path.join(__dirname, "..", "..", "..", "resources", "HWTLPProject", "systeminfo.json");
...
const datajsonfile = fs.readJsonSync(path.join(__dirname, "..", "..", "..", "tests", "regression", "TLP_tests", "datajson", "filesTLP.json"));
 ...
 * @Description `TLP Automation Test Suite`
 * @Date `11/18/2021`
 */
// tslint:disable-next-line:forin
describe.only("Starting TestMaster spec: Running Test Suite: TLP", () => {
    before(async () => {
    ...
    for (const filekey in datajsonfile) {
        const datajson = fs.readJsonSync(path.join(__dirname, "..", "..", "..", "tests", "regression", "TLP_tests", "datajson", datajsonfile[filekey]));
        // look at the keys
        // tslint:disable-next-line:forin
