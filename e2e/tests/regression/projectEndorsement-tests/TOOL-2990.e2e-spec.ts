...
const logClient = new LogClient("e2e:CSP-2991");
...
describe(`${tabTitles.REGRESSION.Deployment} TOOL-2258 Ability for uncertified user to redeploy an un modified project that has been downloaded from the controller`, () => {
    beforeEach(async () => {
        ...
        allure.addLink("Task Issue: TOOL-2990", "https://extron.atlassian.net/browse/TOOL-2990");
        allure.addLink("Test Case: TOOL-T534", "https://extron.atlassian.net/projects/TOOL?selectedItem=com.atlassian.plugins.atlassian-connect-plugin:com.kanoah.test-manager__main-project-page#!/testCase/TOOL-T534");
    ...
    it("verify that stray files fo not linger upon deploying a different project", async () => {
...
describe(`${tabTitles.REGRESSION.Deployment} TOOL-2258 Ability for uncertified user to redeploy an un modified project that has been downloaded from the controller`, () => {
    beforeEach(async () => {
        ...
        allure.story("TOOL-2258: Ability for uncertified user to redeploy an un modified project that has been downloaded from the controller");
        allure.addLink("User Story: TOOL-2258", "https://extron.atlassian.net/browse/TOOL-2258");
        allure.addLink("Task Issue: TOOL-2991", "https://extron.atlassian.net/browse/TOOL-2991");
    ...
    it("Verify that Uncertified User can Redeploy an un Modified Project that has Been Downloaded from the Controller", async () => {
        ...
        await common.switchToWin(browser, tabTitles.mainTab, data.unLicensedUser2, data.unLicensedUser2pass, true);
...
describe(`${tabTitles.REGRESSION.Deployment} TOOL-2258 Ability for uncertified user to redeploy an un modified project that has been downloaded from the controller`, () => {
    beforeEach(async () => {
        ...
        allure.story("TOOL-2258: Ability for uncertified user to redeploy an un modified project that has been downloaded from the controller");
        allure.addLink("User Story: TOOL-2258", "https://extron.atlassian.net/browse/TOOL-2258");
        allure.addLink("Task Issue: TOOL-2990", "https://extron.atlassian.net/browse/TOOL-2991");
        allure.addLink("Test Case: TOOL-T524", "https://extron.atlassian.net/projects/TOOL?selectedItem=com.atlassian.plugins.atlassian-connect-plugin:com.kanoah.test-manager__main-project-page#!/testCase/TOOL-T524");
        return new Promise<void>(async (resolve) => {
            await browser.pause(10000);
            await browser.switchWindow(tabTitles.mainTab);
            await common.switchToWin(browser, tabTitles.mainTab, data.licensedUser1, data.licensedUser1pass);
    ...
    it("verify that Certified User can Redeploy an un Modified Project that has Been Downloaded from the Controller", async () => {
        await common.deleteFolderContents(downloadPath)
            .then(async () => { })
            .catch((err: Error) => {
                logClient.error("Exception caught: " + `${err}`);
