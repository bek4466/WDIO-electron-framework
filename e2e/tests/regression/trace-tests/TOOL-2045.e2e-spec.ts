 ...
 * @LinkToJIRA `https://extron.atlassian.net/browse/TOOL-2045`
 * @Date `10/15/2020`
 */
...
describe(`${tabTitles.REGRESSION.Deployment} TOOL-1598:(TroubleShooting)`, () => {
    beforeEach(async () => {
        ...
        allure.addLink("Task Issue: TOOL-2045", "https://extron.atlassian.net/browse/TOOL-2045");
    ...
    it("Verify that Trace Log can be started without a program running", async () => {
        return new Promise<void>(async (resolve) => {
            ...
            logClient.error("TOOL-2045: Exception Error: " + `${err}`);
            //fail('TOOL-2045: "Troubleshooting"');
